...
> Веб-сайт для бар-ресторана «Пивница» с функционалом онлайн-бронирования, меню и афиши мероприятий.
...
└── portal/                  # Основное приложение
    ...
    │       ├── menu.html    # Меню
    │       ├── events.html  # Афиша
    │       ├── paper_menu.html # Бумажное меню
    │       ├── reservation_form.html   # Форма бронирования
    │       └── reservation_success.html # Успешное бронирование
